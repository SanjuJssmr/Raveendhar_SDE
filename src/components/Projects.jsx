...
import proj9 from "../assets/interface1.webp"
...
const Projects = () => {
    const projects = [
        {
            ...
            image: proj9,
            link: "https://github.com/SanjuJssmr"
        },
        {
            name: "MobiMart",
            image: proj8,
    ...
    return (
        <div className='py-10 '>
            <div className="flex w-full font-poppins gap-2 pb-8 flex-col items-center justify-center  ">
                <h2 className="text-2xl font-medium text-[#fa3c4c] text-opacity-80 uppercase flex items-center justify-center gap-2 leading-heading">Projects</h2>
            ...
            <div>
                <section data-aos='fade-up' className='flex items-center justify-center flex-wrap gap-5'>
                    {projects?.map((proj, i) => (
                        <div key={proj.name} className='flex relative text-[#2F5061] rounded-xl flex-col w-[250px] height-[400px] backdrop-blur-3xl bg-gradient-to-t drop-shadow-md shadow-md  from-[#f6f6f6] to-gray-100 p-1 items-center justify-between hover:-translate-y-1 hover:shadow-lg transition-all duration-300'>
                            ...
                            <section className='flex w-full bg-gradient-to-t mt-24 mb-5 pt-2 rounded-t-xl border-t-[1px] justify-start  border-[#707070]  from-[#f6f6f6] to-gray-100 flex-col z-20  items-center gap-3'>
                                <h1 className='text-xl font-bold pt-2 text-gray-500 leading-heading'>{proj.name}</h1>
