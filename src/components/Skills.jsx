        ...
        <div className='flex flex-col w-full items-center justify-center'>
            ...
            <div className='flex w-full h-full pb-10 pt-10 px-10 sm:px-40'>
                <section className='flex xl:text-9xl sm:text-7xl text-4xl gap-10 flex-wrap items-center justify-center text-opacity-50 text-[#1877f2]'>
                    ...
                    <div className='flex gap-3 flex-col sm:w-24 sm:h-32 w-14 h-20  items-center justify-center '>  <FaAws /><p className='text-sm text-gray-500 '>EC2/ECS</p></div>
                    ...
                    <div className='flex gap-3 flex-col sm:w-24 sm:h-32 w-14 h-20  items-center justify-center'> <SiAmazons3 /><p className='text-sm text-gray-500 '>S3</p></div>
                    <div className='flex gap-3 flex-col sm:w-24 sm:h-32 w-14 h-20  items-center justify-center text-gray-400 '><SiAmazoncloudwatch /><p className='text-sm text-gray-500 '>Cloud-Watch</p></div>
                    <div className='flex gap-3 flex-col sm:w-24 sm:h-32 w-14 h-20  items-center justify-center  '><SiAmazonsqs /><p className='text-sm text-gray-500 '>SQS</p></div>
